...
$configs = [
    ...
    'fields' => [
        ...
        [
            'name' => "room",   //厅室
            'selector' => "//div[6]/div[3]/div[2]/ul[1]/li[2]/text()[2]",
            'required' => false,
        ],
        [
            'name' => "area",   //面积
            'selector' => "//div[6]/div[3]/div[2]/ul[1]/li[2]/span[@title]",
            'required' => false,
        ],
        [
            'name' => "money",   //租金
            'selector' => "//strong[@class='red price bold']",
            'required' => false,
        ],
        [
            'name' => "method",  //出租方式
            'selector' => "//div[6]/div[3]/div[2]/ul[1]/li[1]/text()",
            'required' => false,
        ],
        [
            'name' => "village",    //小区
            'selector' => "//*[@id=\"agantzfxq_C02_07\"]",
            'required' => false,
        ],
        [
            'name' => "address",    //地址
            'selector' => "//div[6]/div[3]/div[2]/ul[1]/li[4]/text()",
            'required' => false,
        ],
        [
            'name' => "contacts",    //联系人
            'selector' => "//div[6]/div[3]/div[2]/div[1]/span[2]",
            'required' => false,
        ],
        [
            'name' => "telphone",    //联系电话
        ...
        [
            ...
            'selector' => "//div[6]/div[2]/p[1]/span[2]",
            'required' => false,
        ],
    ],
];
